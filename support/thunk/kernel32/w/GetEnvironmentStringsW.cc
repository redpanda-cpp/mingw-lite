#include "GetEnvironmentStringsW.h"
...
namespace mingw_thunk
{
  ...
  {
    __DISPATCH_THUNK_2(GetEnvironmentStringsW,
                       i::is_nt(),
                       &__ms_GetEnvironmentStringsW,
                       &f::win9x_GetEnvironmentStringsW);

    return dllimport_GetEnvironmentStringsW();
  }
  ...
  namespace f
  {
    LPWCH __stdcall win9x_GetEnvironmentStringsW()
    {
      ...
      int w_size =
          __ms_MultiByteToWideChar(CP_ACP, 0, a_env, a_size, nullptr, 0);
      wchar_t *w_env =
