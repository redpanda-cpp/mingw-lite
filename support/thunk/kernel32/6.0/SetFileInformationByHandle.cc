#include "SetFileInformationByHandle.h"
...
namespace mingw_thunk
{
  ...
  {
    __DISPATCH_THUNK_2(SetFileInformationByHandle,
                       const auto pfn = try_get_SetFileInformationByHandle(),
                       pfn,
                       &f::fallback_SetFileInformationByHandle);

    return dllimport_SetFileInformationByHandle(
  ...
  namespace f
  {
        ...
        _In_ DWORD dwBufferSize)
    {
      ...
      case FileIoPriorityHintInfo:
        NtFileInformationClass = g::FileIoPriorityHintInformation;
