#include "CompareStringOrdinal.h"
...
namespace mingw_thunk
{
  ...
  __DEFINE_THUNK(kernel32,
                 ...
                 _In_ LPCWCH lpString1,
                 _In_ int cchCount1,
                 _In_ LPCWCH lpString2,
                 _In_ int cchCount2,
                 _In_ BOOL bIgnoreCase)
  {
    __DISPATCH_THUNK_2(CompareStringOrdinal,
                       const auto pfn = try_get_CompareStringOrdinal(),
                       pfn,
                       &f::fallback_CompareStringOrdinal);

    return dllimport_CompareStringOrdinal(
