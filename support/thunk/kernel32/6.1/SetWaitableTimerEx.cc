...
namespace mingw_thunk
{
  ...
  {
    __DISPATCH_THUNK_2(SetWaitableTimerEx,
                       const auto pfn = try_get_SetWaitableTimerEx(),
                       pfn,
                       &f::fallback_SetWaitableTimerEx);

    return dllimport_SetWaitableTimerEx(_hTimer,
                                        _lpDueTime,
                                        _iPeriod,
