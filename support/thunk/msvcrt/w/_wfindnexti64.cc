...
namespace mingw_thunk
{
  ...
  {
    __DISPATCH_THUNK_2(_wfindnexti64,
                       i::is_nt(),
                       &__ms__wfindnext32i64,
                       &f::win9x__wfindnexti64);

    return dllimport__wfindnexti64(handle, fileinfo);
  }

  namespace f
  {
    int win9x__wfindnexti64(intptr_t handle, struct _wfinddata32i64_t *fileinfo)
    {
