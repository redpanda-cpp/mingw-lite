...
namespace mingw_thunk
{
  ...
  {
    __DISPATCH_THUNK_2(
        _wfindnext32, i::is_nt(), &__ms__wfindnext32, &f::win9x__wfindnext32);

    return dllimport__wfindnext32(handle, fileinfo);
  }

  namespace f
  {
    int win9x__wfindnext32(intptr_t handle, struct _wfinddata32_t *fileinfo)
    {
