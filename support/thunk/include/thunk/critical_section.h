...
namespace mingw_thunk
{
  ...
  namespace i
  {
    ...
    {
      switch (os_version().minor) {
      case g::critical_section_os_minor_win95:
        return g::critical_section_os_minor_win95;
      case g::critical_section_os_minor_win98:
        return g::critical_section_os_minor_win98;
      case g::critical_section_os_minor_winme:
        return g::critical_section_os_minor_winme;
      default:
  ...
  namespace d
  {
    ...
    struct critical_section_t
    {
      ...
      {
        bool ok =
            i::critical_section_os_minor() == g::critical_section_os_minor_win95
                ? type.win95 == 4
                : type.win98_winme == 4;
        if (!ok) [[unlikely]] {
    ...
    struct critical_section_impl
    {
      ...
      uintptr_t current_thread()
      {
        static const ptrdiff_t tdbx_offset =
            i::critical_section_os_minor() == g::critical_section_os_minor_winme
                ? 0x80
                : 0x50;
