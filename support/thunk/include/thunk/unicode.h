...
namespace mingw_thunk
{
  ...
  namespace i
  {
    ...
    constexpr int u16_dec_2(d::u16_2 s)
    {
    ...
    constexpr d::u16_2 u16_enc_2(char32_t ch)
    {
  ...
  namespace i
  {
    ...
    constexpr char32_t u8_dec_2(d::u8_2 s)
    {
    ...
    constexpr char32_t u8_dec_3(d::u8_3 s)
    {
    ...
    constexpr char32_t u8_dec_4(d::u8_4 s)
    {
      uint8_t b0 = s.b0 & 0b0000'1111;
      uint8_t b1 = s.b1 & 0b0011'1111;
      uint8_t b2 = s.b2 & 0b0011'1111;
    ...
    constexpr d::u8_2 u8_enc_2(char32_t ch)
    {
    ...
    constexpr d::u8_3 u8_enc_3(char32_t ch)
    {
    ...
    constexpr d::u8_4 u8_enc_4(char32_t ch)
    {
  ...
  namespace g
  {
    constexpr d::u8_3 u8_rep = i::u8_enc_3(u16_rep);
  }
} // namespace mingw_thunk
