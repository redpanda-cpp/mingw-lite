...
namespace mingw_thunk
{
  namespace musl
  {
    ...
    constexpr unsigned ALT_FORM = 1U << ('#' - ' ');
    constexpr unsigned ZERO_PAD = 1U << ('0' - ' ');
    constexpr unsigned LEFT_ADJ = 1U << ('-' - ' ');
    constexpr unsigned PAD_POS = 1U << (' ' - ' ');
    constexpr unsigned MARK_POS = 1U << ('+' - ' ');
    constexpr unsigned GROUPED = 1U << ('\'' - ' ');
    ...
    static const unsigned char states[]['z' - 'A' + 1] = {
        {
            /* 0: bare types */
            /* A-G */ DBL,  0,     UINT, 0,    DBL,     DBL,   DBL,
            /* H-N */ 0,    0,     0,    0,    BIGLPRE, 0,     0,
            /* O-T */ 0,    0,     0,    0,    PTR,     0,
            /* U-Z */ 0,    0,     0,    UINT,  0,       0,
            /* gap */ 0,    0,     0,    0,    0,       0,
            /* a-g */ DBL,  0,     INT,  INT,  DBL,     DBL,   DBL,
            /* h-n */ HPRE, INT,   JPRE, 0,    LPRE,    NOARG, PTR,
            /* o-t */ UINT, UIPTR, 0,    0,    PTR,     ZTPRE,
            /* u-z */ UINT, 0,     0,    UINT, 0,       ZTPRE,
        },
        {
            /* 1: l-prefixed */
            /* A-G */ DBL,   0,     0,     0,    DBL,   DBL,   DBL,
            /* H-N */ 0,     0,     0,     0,    0,     0,     0,
            /* O-T */ 0,     0,     0,     0,    0,     0,
            /* U-Z */ 0,     0,     0,     ULONG, 0,    0,
            /* gap */ 0,     0,     0,     0,    0,     0,
            /* a-g */ DBL,   0,     UINT,  LONG, DBL,   DBL,   DBL,
            /* h-n */ 0,     LONG,  0,     0,    LLPRE, 0,     PTR,
            /* o-t */ ULONG, 0,     0,     0,    PTR,   0,
            /* u-z */ ULONG, 0,     0,     ULONG, 0,    0,
        },
        {
            /* 2: ll-prefixed */
            /* A-G */ 0,      0,      0,      0,    0,      0,      0,
            /* H-N */ 0,      0,      0,      0,    0,      0,      0,
            /* O-T */ 0,      0,      0,      0,    0,      0,
            /* U-Z */ 0,      0,      0,      ULLONG, 0,     0,
            /* gap */ 0,      0,      0,      0,    0,      0,
            /* a-g */ 0,      0,      0,      LLONG, 0,      0,      0,
            /* h-n */ 0,      LLONG,  0,      0,    0,      0,      PTR,
            /* o-t */ ULLONG, 0,      0,      0,    0,      0,
            /* u-z */ ULLONG, 0,      0,      ULLONG, 0,     0,
        },
        {
            /* 3: h-prefixed */
            /* A-G */ 0,       0,       0,       0,    0,       0,      0,
            /* H-N */ 0,       0,       0,       0,    0,       0,      0,
            /* O-T */ 0,       0,       0,       0,    0,       0,
            /* U-Z */ 0,       0,       0,       USHORT, 0,      0,
            /* gap */ 0,       0,       0,       0,    0,       0,
            /* a-g */ 0,       0,       0,       SHORT, 0,       0,      0,
            /* h-n */ HHPRE,   SHORT,   0,       0,    0,       0,      PTR,
            /* o-t */ USHORT,  0,       0,       0,    0,       0,
            /* u-z */ USHORT,  0,       0,       USHORT, 0,      0,
        },
        {
            /* 4: hh-prefixed */
            /* A-G */ 0,      0,      0,      0,    0,      0,      0,
            ...
            /* U-Z */ 0,      0,      0,      UCHAR, 0,      0,
            /* gap */ 0,      0,      0,      0,     0,      0,
            /* a-g */ 0,      0,      0,      CHAR,  0,      0,      0,
            /* h-n */ 0,      CHAR,   0,      0,     0,      0,      PTR,
            /* o-t */ UCHAR,  0,      0,      0,     0,      0,
            /* u-z */ UCHAR,  0,      0,      UCHAR, 0,      0,
        },
        {
            /* 5: L-prefixed */
            /* A-G */ LDBL, 0,    0,    0,    LDBL, LDBL, LDBL,
            /* H-N */ 0,    0,    0,    0,    0,    0,    0,
            /* O-T */ 0,    0,    0,    0,    0,    0,
            /* U-Z */ 0,    0,    0,    0,    0,    0,
            /* gap */ 0,    0,    0,    0,    0,    0,
        ...
        },
        {
            ...
            /* U-Z */ 0,      0,      0,      SIZET, 0,      0,
            /* gap */ 0,      0,      0,      0,     0,      0,
            /* a-g */ 0,      0,      0,      PDIFF, 0,      0,      0,
            /* h-n */ 0,      PDIFF,  0,      0,     0,      0,      PTR,
            /* o-t */ SIZET,  0,      0,      0,     0,      0,
            /* u-z */ SIZET,  0,      0,      SIZET, 0,      0,
        },
        {
            /* 7: j-prefixed */
            /* A-G */ 0,     0,     0,     0,    0,     0,     0,
            ...
            /* U-Z */ 0,     0,     0,     UMAX, 0,     0,
            /* gap */ 0,     0,     0,     0,    0,     0,
            /* a-g */ 0,     0,     0,     IMAX, 0,     0,     0,
            /* h-n */ 0,     IMAX,  0,     0,    0,     0,     PTR,
            /* o-t */ UMAX,  0,     0,     0,    0,     0,
            /* u-z */ UMAX,  0,     0,     UMAX, 0,     0,
        }
    };
